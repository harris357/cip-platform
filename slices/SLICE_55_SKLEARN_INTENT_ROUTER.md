# Slice 55 — Sklearn intent router with deterministic arg extraction
...
INSERT INTO bot_tunables (tenant_id, key, value_json, notes) VALUES
  ('00000000-0000-0000-0000-000000000000', 'lg.classifier_enabled',              'true',
   'Per-tenant kill switch. False reverts to pre-Slice-55 behaviour byte-for-byte.'),
...
slices/SLICE_55_SKLEARN_INTENT_ROUTER.md                            this file
```
...
- Phase 5 (drop triage) is a separate slice. After Slice 55 is stable, triage's narrow role (clarification flagging) is something the classifier already does better.
